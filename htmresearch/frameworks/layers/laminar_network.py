...
from htmresearch.frameworks.layers.l2_l4_network_creation import (
  ...
  createMultipleL4L2ColumnsWithSubsamplingTopology)
...
def createNetwork(networkConfig):
  ...
  elif networkConfig["networkType"] == "MultipleL4L2ColumnsWithSubsamplingTopology":
    return createMultipleL4L2ColumnsWithSubsamplingTopology(network, networkConfig)
