  ...
  def initialize(self):
    ...
    if self._tm is None:
      ...
      if self.implementation == "ApicalTiebreakCPP":
        ...
        cls = htmresearch_core.experimental.ApicalTiebreakSequenceMemory
        ...
        cls = htmresearch.algorithms.apical_tiebreak_temporal_memory.ApicalTiebreakSequenceMemory

      elif self.implementation == "ApicalDependent":
        params["reducedBasalThreshold"] = self.reducedBasalThreshold

        import htmresearch.algorithms.apical_dependent_temporal_memory
        cls = htmresearch.algorithms.apical_dependent_temporal_memory.ApicalDependentSequenceMemory
