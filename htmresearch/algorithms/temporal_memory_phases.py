...
"""
A deprectated version of Temporal Memory implementation in Python. Uses
the 4 phases as described in the BAMI Pseudocode.  An updated version
of temporal memory lives in github.com/numenta/nupic. They do not operate
in the exact same way because calls to the random number generator
