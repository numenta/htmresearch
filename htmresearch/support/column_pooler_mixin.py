...
class ColumnPoolerMonitorMixin(MonitorMixinBase):
  ...
  def compute(self,
    ...
    self._mmTraces["numDistalSegments"].data.append(
      self.numberOfDistalSegments())
    self._mmTraces["numDistalSynapses"].data.append(
      self.numberOfDistalSynapses())
    self._mmTraces["numConnectedDistalSynapses"].data.append(
      self.numberOfConnectedDistalSynapses())
    self._mmTraces["numProximalSynapses"].data.append(
      self.numberOfProximalSynapses())
    self._mmTraces["numConnectedProximalSynapses"].data.append(
      self.numberOfConnectedProximalSynapses())
