...
def plotResult():
  ...
  plt.hold(True)
  plt.subplot(2,2,1)
  plt.semilogx(resultTM['trainSeqN'], 100*np.mean(resultTM['correctRateAll'],1),'-*')
  plt.semilogx(resultLSTM['trainSeqN'], 100*np.mean(resultLSTM['correctRateAll'],1),'-s')
  plt.xlabel(' Training Sequence Number')
  plt.ylabel(' Hit Rate (Best Match) (%)')
  plt.subplot(2,2,2)
  plt.semilogx(resultTM['trainSeqN'], 100*np.mean(resultTM['missRateAll'],1),'-*')
  plt.semilogx(resultLSTM['trainSeqN'], 100*np.mean(resultLSTM['missRateAll'],1),'-*')
  plt.xlabel(' Training Sequence Number')
