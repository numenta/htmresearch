...
\subsection{Loewenstein: Drastic synaptogenesis in adult cortex}

Loewenstein et al \cite{Loewenstein2015} monitored a few thousand dendritic spines in the auditory cortex of adult mouse longitudinally using chronic in vivo 2-photon imaging. The authors observed substantial spine turn over: 30\% of the spines change within 4 days. The reported turnover rates in this study are higher than previous studies.
...
\subsection{Van Essen 2005}

In this 2005 review paper, Van Essen described the cortical and thalamocortical information flow in the primate visual system \cite{VanEssen2005}. Van Essen directly questioned Sherman's proposal that the cortical-thalamic-cortical pathway (CTC) is the main feedforward pathway. He pointed out that the CTC pathway has many fewer axons than the direct CC pathway, and that the receptive fields of the thalamic relay cells are spatially precise but otherwise much less specific than the cells in layers 2/3 that project directly. Thus the CTC path throws away a lot of what was calculated in a region.

This review paper also brought up the difference in the what/where streams in the CTC/CC pathway. The CC pathways are interconnected across what and where. The CTC pathways are not, or only sometimes interconnected across what and where.

\subsection{Marion et al., 2013}
This paper performed a morphological and neurochemical comparisons of the the CC and CTC projections in the receiving cortical region \cite{Marion2013}. They found that V1 and lateral pulvinar projections to V2 are similar in that they target the same layers (**Layer 4**) and lack PV. Projections from pulvinar to V2, however, bear a greater similarity to projections from LGN to V1 because of their larger bouton sizes (measured at the same location in V2) and positive staining for Vglut2. These data lend support to the hypothesis that the pulvinar could act as a driver for V2.
