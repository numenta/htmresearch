...
from htmresearch.algorithms.lateral_pooler_wrapper import SpatialPooler as LaterPoolerWrap
...
def createSpatialPooler(spatialImp, spatialPoolerParameters):
  ...
  elif spatialImp == "lateral":
    sp = LaterPoolerWrap(**spatialPoolerParameters)
