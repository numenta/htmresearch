...
from htmresearch.frameworks.sp_paper.sp_metrics import calculateEntropy
    ...
    with open(inputFilePath, 'r') as inputFile:
      ...
      for row in reader:
        ...
        for valueString in sequence_values:
          ...
          # Note: instead of just the tmPredictedActiveCells this could be a 
          # weighted combination of other TM / SP outputs.
...
def main():
  ...
  parser.add_argument('--config', '-c',
                      dest='config',
                      type=str,
                      default='configs/synthetic_control.yml',
