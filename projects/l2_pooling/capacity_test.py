...
def runExperiment3(numCorticalColumns=DEFAULT_NUM_CORTICAL_COLUMNS,
  ...
  expParams = []
  expParams.append({'l4Column': 150, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  expParams.append({'l4Column': 256, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  expParams.append({'l4Column': 512, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  expParams.append({'l4Column': 1024, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})

  # expParams.append({'l4Column': 256, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  # expParams.append({'l4Column': 256, 'externalInputSize': 2400, 'w': 10, 'sample': 6, 'thresh': 4})
  # expParams.append({'l4Column': 512, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  # expParams.append({'l4Column': 512, 'externalInputSize': 2400, 'w': 10, 'sample': 6, 'thresh': 4})
  # expParams.append({'l4Column': 1024, 'externalInputSize': 2400, 'w': 20, 'sample': 10, 'thresh': 6})
  # expParams.append({'l4Column': 1024, 'externalInputSize': 2400, 'w': 10, 'sample': 6, 'thresh': 4})
