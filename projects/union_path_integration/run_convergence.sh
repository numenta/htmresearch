...
python convergence_simulation.py --numObjects 100 --numUniqueFeatures 30 --locationModuleWidth 20 --resultName results/cumulative_convergence_400_cpm_50_feats_100_objs.json --repeat 10 &
python convergence_simulation.py --numObjects 100 --numUniqueFeatures 30 --locationModuleWidth 10 --resultName results/cumulative_convergence_100_cpm_50_feats_100_objs.json --repeat 10 &
python ideal_sim.py &
python bof_sim.py &
wait
