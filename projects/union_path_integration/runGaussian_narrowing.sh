...
python convergence_simulation.py --bumpType gaussian --numObjects 40 50 60 70 --numUniqueFeatures 40 --locationModuleWidth 10 --numSensations 9 --seed1 42 --seed2 42 --logCellActivity --resultName results/narrowing_gaussian.json
